...
<head>
    ...
    <style>
        ...
        .container {
            ...
            width: 100%;
            margin: 10px 30px;
            border: 2px solid #ec2a2a; /* Border in pastel green */
            display: flex;
        ...
        .buttons a {
            background-color: #a80f0f; /* Pastel green */
            color: #ffffff;
            padding: 15px 30px;
            border-radius: 5px;
        ...
        .buttons a:hover {
            background-color: #aa152b; /* Darker green */
        }
        .buttons a:active {
...
<div class="container">
    ...
    <div class="title">Bienvenido a Examen Final Programacion 3</div>
    <div class="description-container">
        <div class="description">Gestione sus registro de alumnos de manera eficiente.</div>
    </div>
